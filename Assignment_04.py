{
  ...
  "metadata": {
    "colab": {
      ...
      "provenance": [],
      "collapsed_sections": [],
      "authorship_tag": "ABX9TyOr9F2gsomihWZE/qmxUDIQ",
  ...
  "cells": [
    {
      ...
      "source": [
        "<a href=\"https://colab.research.google.com/github/tejasnikumbh999/Covid/blob/main/Assignment_04.py\" target=\"_parent\"><img src=\"https://colab.research.google.com/assets/colab-badge.svg\" alt=\"Open In Colab\"/></a>"
      ]
    },
    {
      "cell_type": "code",
    ...
    },
    {
      ...
      "source": [
        ...
        "   html.Audio(src='https://quz1yp-a.akamaihd.net/downloads/ringtones/files/mp3/ayogi-309.mp3',controls=True,autoPlay=True,title='IPL Anthem',loop=True),\n",
        ...
        "       html.Audio(src='https://www.downloadmobileringtones.com/mp3ringtone/KKR-Theme-Song-Ipl-2021-Ringtone-Download-dmr.mp3', controls=True,title='KKR')]),\n",
        "       html.Div([html.H1(children='KKR Anthem'),\n",
        "       html.Audio(src='https://www.downloadmobileringtones.com/mp3ringtone/KKR-Theme-Song-Ipl-2021-Ringtone-Download-dmr.mp3', controls=True,title='KKR')\n",
        "       ])\n",
